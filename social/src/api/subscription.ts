...
import { AuthenticatedRequest, deleteAuthenticatedRequest } from '../interface/subscription';
...
export default (app: Express) => {
    ...
    app.post('/create-subscription', UserAuth, async (req: AuthenticatedRequest, res: Response, next: NextFunction) => {
        try {
    ...
    app.put('/update-subscription', UserAuth, async (req: AuthenticatedRequest, res: Response, next: NextFunction) => {
        try {
            let authUser: any = req.user;
            req.body.userId = authUser._id;
